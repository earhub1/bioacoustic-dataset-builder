...
7. **(Opcional) Visualizar sequências**: as ferramentas de visualização anteriores foram removidas para reconstrução futura. No momento, foque nos manifestos (`manifest_sequences.csv` e manifestos por split) para auditoria manual dos segmentos e composição das fitas.
